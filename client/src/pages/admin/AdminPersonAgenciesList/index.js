...
function AdminPersonAgenciesList({
  getAllAdminPersonUsers,
  usersList,
  adminPersonPannel,
  local,
...
AdminPersonAgenciesList.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminPersonAgenciesList);