...
function AdminPersonAdminsList({
  getAllAdminPersonUsers,
  usersList,
  adminPersonPannel,
  local,
...
AdminPersonAdminsList.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminPersonAdminsList);