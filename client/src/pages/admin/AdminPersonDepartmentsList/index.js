...
function AdminPersonDepartmentsList({
  getAllAdminPersonUsers,
  usersList,
  adminPersonPannel,
  local,
  ...
  React.useEffect(() => {
    getAllAdminPersonUsers("ORG_SUB");
  }, []);
...
AdminPersonDepartmentsList.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminPersonDepartmentsList);