...
function selectedUsersNames(agencyCustomersList, selectedIds) {
    const names = agencyCustomersList.reduce((acc, item) => {
...
class AgencyAdminCostumers extends React.Component {
    ...
    state = {
        ...
        data: this.props.agencyCustomersList || []
    };

    componentDidUpdate(prevProps) {
        if (this.props.agencyCustomersList !== prevProps.agencyCustomersList) {
          this.setState({ data: this.props.agencyCustomersList })
        }
    }
    ...
    handleDeleteAdminAgencies = () => {
          this.props.deleteAdminAgencyCustomer(this.state.selected);
    }

    handleChangeSearchFilter = (value) => {
        const rawData = [...this.props.agencyCustomersList];
                                        ...
                                        <TableBody>
                                            ...
                                            .map(n => {
                                                ...
                                                >
                                                    ...
                                                    <TableCell>
                                                        <NavLink to={`/${local.language}/admin/agencyCustomer/${match.params.id}/${n.id}`}>
                                                            View Details
                                                        </NavLink>
                                                    </TableCell>
                                                </TableRow>
...
AgencyAdminCostumers.propTypes = propTypes;


export default AgencyAdminCostumers;