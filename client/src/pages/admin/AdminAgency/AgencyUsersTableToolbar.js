...
function AgencyUsersTableToolbar({
  numSelected,
          ...
          <div>
            {
              ...
              <Tooltip title="Delete">
                <IconButton aria-label="Delete" onClick={handleOpenDeleteModal}>
                  ...
                  <NavLink to={`/${local.language}/admin/${entity === 'user' ? 'addNewAgencyUser' : 'addNewAgencyCustomer'}/${agencyId}`}> 
...
AgencyUsersTableToolbar.propTypes = propTypes;

export default AgencyUsersTableToolbar;