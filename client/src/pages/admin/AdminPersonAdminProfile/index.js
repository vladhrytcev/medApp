...
function AdminPersonAdminProfile({
    match,
    local,
    currentUser,
    editCurrentUser,
                    ...
                    <Grid container spacing={6}>
                        <Grid item xs={12}>
                            <Breadcrumbs aria-label="Breadcrumb" mt={2}>
                                <Link component={NavLink} exact to={`/${local.language}/admin/persons/admins`}>
                                    Admins List
                                </Link>
                                <Typography>Admin {currentUser.firstName}&nbsp;{currentUser.lastName}</Typography>
                            </Breadcrumbs>
                            <PersonAgencyProfile
...
AdminPersonAdminProfile.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminPersonAdminProfile);