...
import OrganisationUsersTableToolbar from './OrganisationUsersTableToolbar';
import OrganisationUsersTableHead from './OrganisationUsersTableHead';
...
function selectedUsersNames(organisationUsersList, selectedIds) {
    const names = organisationUsersList.reduce((acc, item) => {
...
class OrganisationAdminUsers extends React.Component {
    ...
    state = {
        ...
        data: this.props.organisationUsersList || []
    };

    componentDidUpdate(prevProps) {
        if (this.props.organisationUsersList !== prevProps.organisationUsersList) {
          this.setState({ data: this.props.organisationUsersList })
        }
    }
    ...
    handleDeleteOrganisationAgencies = () => {
          this.props.deleteAdminOrganisationUsers(this.state.selected);
    }

    handleChangeSearchFilter = (value) => {
        const rawData = [...this.props.organisationUsersList];
                                        ...
                                        <TableBody>
                                            ...
                                            .map(n => {
                                                ...
                                                >
                                                    ...
                                                    <TableCell>
                                                        <NavLink to={`/${local.language}/admin/organisation/${match.params.id}/${n.id}`}>
                                                            View Details
                                                        </NavLink>
                                                    </TableCell>
                                                </TableRow>
...
OrganisationAdminUsers.propTypes = propTypes;


export default OrganisationAdminUsers;