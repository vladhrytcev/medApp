...
function DeleteCustomerssModalWindow({
        ...
        <Fade in={isDeleteModalVisible}>
          <div className={classes.paper}>
            <Typography
                ...
                gutterBottom
            >
                Are you sure want to delete this department customers:
            </Typography>
            {
...
DeleteCustomerssModalWindow.propTypes = propTypes;

export default DeleteCustomerssModalWindow