...
function DeleteUsersModalWindow({
        ...
        <Fade in={isDeleteModalVisible}>
          <div className={classes.paper}>
            <Typography
                ...
                gutterBottom
            >
                Are you sure want to delete this agencies:
            </Typography>
            {
...
DeleteUsersModalWindow.propTypes = propTypes;

export default DeleteUsersModalWindow