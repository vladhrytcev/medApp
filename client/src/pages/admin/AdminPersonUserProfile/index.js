...
import PersonUserProfile from './PersonUserProfile';
...
function AdminPersonUserProfile({
    match,
    local,
    currentUser,
    editCurrentUser,
...
AdminPersonUserProfile.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminPersonUserProfile);