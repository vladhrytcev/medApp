...
import { adminPannel as routes } from "../routes/index";
...
class AdminPannelSidebar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <Drawer variant="permanent" {...other}>
        <Translation>
          {(t, { i18n }) =>
            <React.Fragment>
              <Brand>
                <BrandIcon /> <Box ml={1}>Medlink</Box>
              </Brand>
              <Scrollbar>
                <List disablePadding>
                  <Items>
...
export default withRouter(AdminPannelSidebar);