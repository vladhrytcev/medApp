...
import { UpdatePreferenceDto } from '../../preference/dto/update-preference.dto';
...
export class UpdateUserDto {
  ...
  readonly qualification?: CreateQualificationDto;
  ...
  @IsOptional()
  @ValidateNested()
  @ApiModelProperty({ type: UpdatePreferenceDto })
  readonly preferences?: UpdatePreferenceDto;
}
